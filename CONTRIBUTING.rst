...
Report bugs at https://github.com/fpgmaas/twitter-sentiment/issues
...
https://github.com/fpgmaas/twitter-sentiment/issues.
...
Ready to contribute? Here's how to set up `twitter-sentiment` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `twitter-sentiment` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/twitter-sentiment.git
